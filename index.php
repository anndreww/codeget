...
<body>
	<div class="container-fluid">
		...
		<header>
			<div class="well"><h2><strong>CodeGet</strong> - Compilator Online</h2></div>
		</header>
		<div class="result">
		<?php
			// if compiled successfully, show output.
			if($exit_status == 0){ ?>
			<div id="pan-bord" class="panel panel-success">
				<div id="panel-cus" class="panel-heading">
					<h5>Output</h5>
				</div>
		...
		<?php
			...
			if($exit_status == 1){ ?>
			<div id="pan-bord" class="panel panel-danger">
				<div id="panel-cus"  class="panel-heading">
					<h5>Error</h5>
				</div>
				<div class="panel-body">
